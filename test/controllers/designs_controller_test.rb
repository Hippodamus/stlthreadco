...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { category: @design.category, description: @design.description, name: @design.name }
    end
  ...
  test "should update design" do
    patch :update, id: @design, design: { category: @design.category, description: @design.description, name: @design.name }
    assert_redirected_to design_path(assigns(:design))
  end
